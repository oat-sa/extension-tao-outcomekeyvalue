...
namespace oat\taoAltResultStorage\models\Entity;
...
class ItemVariableStorable extends VariableStorable
{
     ...
     * @param $callItemId
     */
    public function __construct($deliveryResultIdentifier, $testIdentifier, \taoResultServer_models_classes_Variable $variable, $item, $callItemId)
    {
