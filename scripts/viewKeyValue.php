...
$keyValueStorage = ServiceManager::getServiceManager()->get(
    taoAltResultStorage_models_classes_KeyValueResultStorage::SERVICE_ID
);
$persistenceId = $keyValueStorage->getOption(
    taoAltResultStorage_models_classes_KeyValueResultStorage::OPTION_PERSISTENCE
);
